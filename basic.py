...
slowprint('''\033[93m\033[93m\033[93m  WAIT FOR NEXT...create by sajim''')
os.system ("apt install python -y")
slowprint('''\033[93m\033[93m  WAIT FOR NEXT...create by sajim''')
...
slowprint('''\03[ WAIT FOR NEXT...create by sajim''')
os.system ("apt install w3m -y")
slowprint('''\033 WAIT FOR NEXT...create by sajim''')
os.system ("apt install hydra -y")
slowprint('''\033 Insttaling hydra tool...create by sajim''')
